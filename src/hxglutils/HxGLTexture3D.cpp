...
void HxGLTexture3D::GLTexture3D::updateResource(void* data)
{
...
void HxGLTexture3D::activate(unsigned int contextID)
{
...
void HxGLTexture3D::bind(unsigned int contextID, HxGLShader& shader, int texunit, char* name)
{
    mTexture.update(contextID, &mData);
...
GLuint HxGLTexture3D::getTexture(unsigned int contextID, bool update)
{
...
void HxGLTexture3D::setFetchMode(GLint mode)
{
...
void HxGLTexture3D::setFormat(GLint internalFormat, GLenum format, GLenum type)
{
...
void HxGLTexture3D::setSize(GLsizei width, GLsizei height, GLsizei depth)
{
...
void HxGLTexture3D::setTexture(int size, void *data)
{
    mData.mWidth  = size;
    mData.mHeight = size;
    mData.mDepth  = size;
...
void HxGLTexture3D::setTextureData(void *data)
{
    mData.mData   = data;
...
void HxGLTexture3D::unbind(int texunit)
{
    glActiveTexture(GL_TEXTURE0 + texunit);
    glBindTexture(GL_TEXTURE_3D, 0);
    glActiveTexture(GL_TEXTURE0);
